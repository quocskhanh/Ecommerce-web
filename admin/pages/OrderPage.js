...
const OrderPage = () => {
    ...
    const handleExport = () => {
        const csvData = [
            ["Order", "Date", "Customer", "Payment Status", "Order Status", "Total"],
            ...orders.map(order => [
                order.order,
                order.date,
                order.customer,
                ...
                <table className="w-full text-left">
                    ...
                    {currentOrders.map((order) => (
                        <tr key={order.id} className="border-b hover:bg-gray-50">
                            ...
                            <td className="text-center text-[#06a561] text-sm font-normal font-['Inter'] leading-tight ">{order.paymentStatus}</td>
                            <td className="p-4 text-gray-500">{order.orderStatus}</td>
                        ...
                        <div className="bg-white p-6 rounded shadow-lg">
                            ...
                            <div className="flex justify-end gap-4">
                                <button
                                    ...
                                    onClick={() => {
                                        setIsModalOpen(false);
                                        setEditingOrder(null); // Reset editingOrder khi bấm Cancel
                                        setNewOrder({ product: "", quantity: 0, price: 0, category: "Clothing" }); // Reset newOrder khi bấm Cancel
                                    }}
                                >
                                    Cancel
                                </button>
