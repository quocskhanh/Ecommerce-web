...
const DashboardTopbar = () => {
    ...
    return (
        <div className="w-full h-16 bg-[#070b1d] flex items-center justify-between px-6 shadow-md">
            {/* Logo and Search */}
            <div className="flex items-center gap-4">
                ...
                <div className="relative w-80">
                    ...
                    <svg
                        ...
                        strokeWidth="1.5"
                        stroke="currentColor"
                        className="absolute top-2.5 left-3 w-6 h-6 text-gray-400"
                    >
                        <path
                            strokeLinecap="round"
            ...
            <div className="flex items-center gap-6 text-white">
                ...
                <div className="relative">
                    <span onClick={toggleMessageMenu} className="cursor-pointer">
                    ...
                    {messageMenuVisible && (
                        <ul className="absolute right-0 mt-2 w-64 bg-white shadow-md rounded-md">
                            {messages.map((message) => (
                                <li key={message.id} className="px-4 py-2 cursor-pointer">
